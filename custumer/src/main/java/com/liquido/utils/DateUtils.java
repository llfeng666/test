...
public class DateUtils {
    ...
    public static Date parseDate(String dateOfString, String targetFormat) {
        ...
        String format = getPattern(targetFormat);
        if (format == null) {
            return null;
        }
    ...
    public static String parseDateToString(String dateOfString, String targetFormat) {
        ...
        String format = getPattern(dateOfString);
        if (format == null) {
            return null;
        }
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(format);
    ...
    public static Date getDateByIntervalHours(Date date, int hours) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
...
/*	public static void main(String[] args) throws ParseException {
		// //System.out.println("1:" + getCurrentDate("yyyy-MM-dd
		// HH:mm:ss"));
		// //System.out.println("2:" + date2String(new Date(),
		// "yyyy-MM-dd HH:mm:ss"));
		// //System.out.println("3:" + parseDate("2009-02-18 15:10:09",
		// "yyyyMM"));
		// //System.out.println("4:" + parseDateToString("2009-12-03",
		// "yyyyMM"));
		// //System.out.println("----"+getStringOperMonth("20080312",-3));
		// //System.out.println("----"+getIntervalDays(parseStringToUtilDate("2009-08-03"),parseStringToUtilDate("2009-08-07")));
		// long startdate =
		// parseStringToUtilDate("2009-06-01").getTime();
		// long enddate =
		// parseStringToUtilDate("2009-08-01").getTime();
		//
		// Date date =
		// getDateByIntervalDays(parseStringToUtilDate("2017-03-01"),
		// -1);
		// //System.out.println(date);
		//
		// //System.out.println("--------"+getIntervalMonths("2008-09","2009-12"));
		// //System.out.println(getIntervalDays(parseDate("2009-05-30",
		// "yyyy-MM-dd HH:mm:ss"),parseDate("2009-07-30", "yyyy-MM-dd
		// HH:mm:ss")));

		System.out.println(changeDateStrFormat("20190319", "yyyyMMdd", "yyyy-MM"));
	}*/
    ...
    public static Map<String,String> weekToDayFormate(int year, int week){
        ...
        String startDay = new SimpleDateFormat("yyyyMMdd").format(getDateByIntervalDays(calendar.getTime(),1));
