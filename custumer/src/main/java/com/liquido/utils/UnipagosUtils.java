...
public final class UnipagosUtils {
    ...
    public static PaymentStatus mapUnipagosStatus(final String status) {
        switch (status) {
            case "SETTLED":
            ...
            default:
                ...
                return PaymentStatus.IN_PROGRESS; // pending is our best option
        }
    }
    ...
    // }
    public static PaymentStatus convertReceiptStatus(final String status) {
        switch (status) {
            case "C": // completed
                return PaymentStatus.SETTLED;
            case "X": // cancelled
